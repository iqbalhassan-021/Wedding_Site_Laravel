...
<body>
<section style="height: 100vh; display:flex; justify-content:center; align-items:center; flex-direction:row; " class="u-clearfix u-image u-section-8" id="carousel_81ce" data-image-width="1080" data-image-height="1080">
                  ...
                  <div class="u-form u-radius-5 u-white u-form-1">
                    ...
                    <div class="u-form-group u-form-name">
                      ...
                      <div class="u-form-group u-form-group-3">
                        ...
                        <input type="text" placeholder="Number of Guests" id="text-d56d" name="number_of_guests" class="u-grey-5 u-input u-input-rectangle u-radius-10" required="required">
                      </div>
                      <div class="u-form-group u-form-group-3">
                        <label for="text-d56d" class="u-label"></label>
